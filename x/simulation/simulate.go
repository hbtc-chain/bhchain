...
func initChain(
	r *rand.Rand, params Params, accounts []CU, app *baseapp.BaseApp, appStateFn AppStateFn,
) (mockValidators, time.Time, []CU) {
...
func SimulateFromSeed(
	...
	accs := RandomCUs(r, params.NumKeys)
	...
	// remove module CU address if they exist in accs
	var tmpAccs []CU
...
type blockSimFn func(r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context,
	accounts []CU, header abci.Header) (opCount int)
...
func createBlockSimulator(testingMode bool, tb testing.TB, t *testing.T, w io.Writer, params Params,
	...
	return func(
		r *rand.Rand, app *baseapp.BaseApp, ctx sdk.Context, accounts []CU, header abci.Header,
	) (opCount int) {
...
func runQueuedOperations(queueOps map[int][]Operation,
	...
	ctx sdk.Context, accounts []CU, logWriter LogWriter, event func(route, op, evResult string), lean bool) (numOpsRan int) {
...
func runQueuedTimeOperations(queueOps []FutureOperation,
	...
	app *baseapp.BaseApp, ctx sdk.Context, accounts []CU,
