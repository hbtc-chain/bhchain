...
import (
	...
	"github.com/hbtc-chain/bhchain/x/crisis/internal/types"
...
// SendCoinsFromAccountToFeeCollector transfers amt to the fee collector CU.
func (k Keeper) SendCoinsFromAccountToFeeCollector(ctx sdk.Context, senderAddr sdk.CUAddress, amt sdk.Coins) sdk.Error {
	_, err := k.supplyKeeper.SendCoinsFromAccountToModule(ctx, senderAddr, k.feeCollectorName, amt)
	return err
}
