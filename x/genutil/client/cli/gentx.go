...
import (
	...
	kbkeys "github.com/hbtc-chain/bhchain/crypto/keys"
...
type StakingMsgBuildingHelpers interface {
	...
	BuildCreateValidatorMsg(cliCtx context.CLIContext, txBldr custodianunit.TxBuilder) (custodianunit.TxBuilder, sdk.Msg, error)
}

// GenTxCmd builds the application's gentx command.
// nolint: errcheck
func GenTxCmd(ctx *server.Context, cdc *codec.Codec, mbm module.BasicManager, smbh StakingMsgBuildingHelpers,
	genAccIterator types.GenesisCUsIterator, defaultNodeHome, defaultCLIHome string) *cobra.Command {
...
func readUnsignedGenTxFile(cdc *codec.Codec, r io.Reader) (custodianunit.StdTx, error) {
	var stdTx custodianunit.StdTx
...
func writeSignedGenTx(cdc *codec.Codec, outputDocument string, tx custodianunit.StdTx) error {
