...
func CollectStdTxs(cdc *codec.Codec, moniker, genTxsDir string,
	genDoc tmtypes.GenesisDoc, genAccIterator types.GenesisCUsIterator,
	...
	addrMap := make(map[string]authexported.CustodianUnit)
	genAccIterator.IterateGenesisCUs(cdc, appState,
