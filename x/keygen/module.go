...
import (
	...
	"github.com/hbtc-chain/bhchain/x/keygen/client/cli"
	"github.com/hbtc-chain/bhchain/x/keygen/client/rest"
...
type AppModule struct {
	AppModuleBasic
	keeper        Keeper
	tokenKeeper   internal.TokenKeeper
	cuKeeper      internal.CUKeeper
	orderKeeper   internal.OrderKeeper
	receiptKeeper internal.ReceiptKeeper
	cn            chainnode.Chainnode
}

// NewAppModule creates a new AppModule object
func NewAppModule(keeper Keeper, tk internal.TokenKeeper, ck internal.CUKeeper, ok internal.OrderKeeper,
	rk internal.ReceiptKeeper, cn chainnode.Chainnode) AppModule {
