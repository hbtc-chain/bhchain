...
func getMockApp(t *testing.T) (*mock.App, Keeper) {
	...
	keeper.SetTransferKeeper(bankKeeper)
	...
	require.NoError(t, mApp.CompleteSetup(keyStaking, tkeyStaking, keySupply, keyTransfer))
...
func TestStakingMsgs(t *testing.T) {
	...
	accs := []genaccounts.GenesisCU{acc1, acc2}
