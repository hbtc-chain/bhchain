...
func GetQueryCmd(queryRoute string, cdc *codec.Codec) *cobra.Command {
	...
	stakingQueryCmd.AddCommand(client.GetCommands(
		...
		GetCmdQueryEpoch(queryRoute, cdc),
	)...)
...
Example:
$ %s query staking validator bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegations-from bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegations-from bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking delegation BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			delAddr, err := sdk.CUAddressFromBase58(args[0])
			if err != nil {
				return err
			}
...
Example:
$ %s query staking delegations bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking delegations-to bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegation BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking unbonding-delegation BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp
`,
				version.ClientName,
			),
		),
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			delegatorAddr, err := sdk.CUAddressFromBase58(args[0])
			if err != nil {
				return err
			}
...
Example:
$ %s query staking redelegation BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj bhvaloper1ksn6eszxp4v2sfrf96s5ded4zz9cr9u46uy0hz
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query staking redelegation BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp
`,
				version.ClientName,
			),
		),
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			result, _, err := cliCtx.QueryWithData(route, bz)
			if err != nil {
				return err
			}

			var epoch sdk.Epoch
			cdc.MustUnmarshalJSON(result, &epoch)
