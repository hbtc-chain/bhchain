...
func (h MultiStakingHooks) BeforeDelegationCreated(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	for i := range h {
		h[i].BeforeDelegationCreated(ctx, delAddr, valAddr)
	}
}
func (h MultiStakingHooks) BeforeDelegationSharesModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	for i := range h {
		h[i].BeforeDelegationSharesModified(ctx, delAddr, valAddr)
	}
}
func (h MultiStakingHooks) BeforeDelegationRemoved(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	for i := range h {
		h[i].BeforeDelegationRemoved(ctx, delAddr, valAddr)
	}
}
func (h MultiStakingHooks) AfterDelegationModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	for i := range h {
...
func (h MultiStakingHooks) AfterNewEpoch(ctx sdk.Context, epoch sdk.Epoch) {
	for i := range h {
		h[i].AfterNewEpoch(ctx, epoch)
	}
}
