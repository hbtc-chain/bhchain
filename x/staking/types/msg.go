...
func NewMsgCreateValidator(
	...
	return MsgCreateValidator{
		...
		DelegatorAddress:  sdk.CUAddress(valAddr),
...
func (msg MsgCreateValidator) GetSigners() []sdk.CUAddress {
	// delegator is first signer so delegator pays fees
	addrs := []sdk.CUAddress{msg.DelegatorAddress}
	...
	if !bytes.Equal(msg.DelegatorAddress.Bytes(), msg.ValidatorAddress.Bytes()) {
		...
		// msg as well
		addrs = append(addrs, sdk.CUAddress(msg.ValidatorAddress))
	}
	return addrs
}
...
func (msg MsgCreateValidator) ValidateBasic() sdk.Error {
	...
	if !sdk.CUAddress(msg.ValidatorAddress).Equals(msg.DelegatorAddress) {
...
func (msg MsgEditValidator) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{sdk.CUAddress(msg.ValidatorAddress)}
}
...
type MsgKeyNodeHeartbeat struct {
	Height           uint64         `json:"height" yaml:"height"`
	ValidatorAddress sdk.ValAddress `json:"validator_address" yaml:"validator_address"`
}

func NewMsgKeyNodeHeartbeat(height uint64, valAddr sdk.ValAddress) MsgKeyNodeHeartbeat {
	return MsgKeyNodeHeartbeat{
		Height:           height,
		ValidatorAddress: valAddr,
	}
}
...
//nolint
func (msg MsgKeyNodeHeartbeat) Route() string { return RouterKey }
func (msg MsgKeyNodeHeartbeat) Type() string  { return "key_node_heartbeat" }
func (msg MsgKeyNodeHeartbeat) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{sdk.CUAddress(msg.ValidatorAddress)}
}

// get the bytes for the message signer to sign on
func (msg MsgKeyNodeHeartbeat) GetSignBytes() []byte {
	bz := ModuleCdc.MustMarshalJSON(msg)
	return sdk.MustSortJSON(bz)
}

// quick validity check
func (msg MsgKeyNodeHeartbeat) ValidateBasic() sdk.Error {
	if msg.ValidatorAddress.Empty() {
		return sdk.NewError(DefaultCodespace, CodeInvalidInput, "nil validator address")
	}
	if msg.Height == 0 {
		return sdk.NewError(DefaultCodespace, CodeInvalidInput, "invalid height")
	}
	return nil
}
...
func NewMsgDelegate(delAddr sdk.CUAddress, valAddr sdk.ValAddress, amount sdk.Coin) MsgDelegate {
	return MsgDelegate{
...
func (msg MsgDelegate) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{msg.DelegatorAddress}
}
...
func NewMsgBeginRedelegate(delAddr sdk.CUAddress, valSrcAddr,
...
func (msg MsgBeginRedelegate) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{msg.DelegatorAddress}
}
...
func NewMsgUndelegate(delAddr sdk.CUAddress, valAddr sdk.ValAddress, amount sdk.Coin) MsgUndelegate {
...
func (msg MsgUndelegate) GetSigners() []sdk.CUAddress { return []sdk.CUAddress{msg.DelegatorAddress} }
