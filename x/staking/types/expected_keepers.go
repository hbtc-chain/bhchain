...
type SupplyKeeper interface {
	...
	SendCoinsFromModuleToModule(ctx sdk.Context, senderPool, recipientPool string, amt sdk.Coins) (sdk.Result, sdk.Error)
	UndelegateCoinsFromModuleToAccount(ctx sdk.Context, senderModule string, recipientAddr sdk.CUAddress, amt sdk.Coins) (sdk.Result, sdk.Error)
	DelegateCoinsFromAccountToModule(ctx sdk.Context, senderAddr sdk.CUAddress, recipientModule string, amt sdk.Coins) (sdk.Result, sdk.Error)
...
type ValidatorSet interface {
	...
	Delegation(sdk.Context, sdk.CUAddress, sdk.ValAddress) stakingexported.DelegationI
...
type DelegationSet interface {
	...
	// iterate through all delegations from one delegator by validator-CUAddress,
...
type StakingHooks interface {
	...
	BeforeDelegationCreated(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress)        // Must be called when a delegation is created
	BeforeDelegationSharesModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) // Must be called when a delegation's shares are modified
	BeforeDelegationRemoved(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress)        // Must be called when a delegation is removed
	AfterDelegationModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress)
	BeforeValidatorSlashed(ctx sdk.Context, valAddr sdk.ValAddress, fraction sdk.Dec)
	AfterNewEpoch(ctx sdk.Context, epoch sdk.Epoch)
}
