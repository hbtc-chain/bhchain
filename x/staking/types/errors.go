...
func ErrDelegationBelowKeyNodeThreshold(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "keynode's delegation must be greater than threshold")
}

func ErrKeyNodeNoHeartbeat(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "keynode has no heartbeat recently")
}

func ErrKeyNodeInvalidHeartbeat(codespace sdk.CodespaceType) sdk.Error {
	return sdk.NewError(codespace, CodeInvalidValidator, "invalid heartbeat recently")
}
