...
func TestDelegationEqual(t *testing.T) {
	d1 := NewDelegation(sdk.CUAddress(valAddr1), valAddr2, sdk.NewDec(100))
	d2 := d1
...
func TestDelegationString(t *testing.T) {
	d := NewDelegation(sdk.CUAddress(valAddr1), valAddr2, sdk.NewDec(100))
	require.NotEmpty(t, d.String())
}

func TestUnbondingDelegationEqual(t *testing.T) {
	ubd1 := NewUnbondingDelegation(sdk.CUAddress(valAddr1), valAddr2, 0,
...
func TestUnbondingDelegationString(t *testing.T) {
	ubd := NewUnbondingDelegation(sdk.CUAddress(valAddr1), valAddr2, 0,
		time.Unix(0, 0), sdk.NewInt(0))
...
func TestRedelegationEqual(t *testing.T) {
	r1 := NewRedelegation(sdk.CUAddress(valAddr1), valAddr2, valAddr3, 0,
		time.Unix(0, 0), sdk.NewInt(0),
		sdk.NewDec(0))
	r2 := NewRedelegation(sdk.CUAddress(valAddr1), valAddr2, valAddr3, 0,
		time.Unix(0, 0), sdk.NewInt(0),
		sdk.NewDec(0))
...
func TestRedelegationString(t *testing.T) {
	r := NewRedelegation(sdk.CUAddress(valAddr1), valAddr2, valAddr3, 0,
		time.Unix(0, 0), sdk.NewInt(0),
		sdk.NewDec(10))
...
func TestDelegationResponses(t *testing.T) {
	cdc := codec.New()
	dr1 := NewDelegationResp(sdk.CUAddress(valAddr1), valAddr2, sdk.NewDec(5), sdk.NewInt(5))
	dr2 := NewDelegationResp(sdk.CUAddress(valAddr1), valAddr3, sdk.NewDec(5), sdk.NewInt(5))
...
func TestRedelegationResponses(t *testing.T) {
	...
	rdr1 := NewRedelegationResponse(sdk.CUAddress(valAddr1), valAddr2, valAddr3, entries)
	rdr2 := NewRedelegationResponse(sdk.CUAddress(valAddr2), valAddr1, valAddr3, entries)
