...
func TestMsgCreateValidator(t *testing.T) {
	...
	for _, tc := range tests {
		...
		msg := NewMsgCreateValidator(tc.validatorAddr, tc.pubkey, tc.bond, description, tc.CommissionRates, tc.minSelfDelegation, true)
		if tc.expectPass {
...
func TestMsgEditValidator(t *testing.T) {
	...
	for _, tc := range tests {
		...
		msg := NewMsgEditValidator(tc.validatorAddr, description, &newRate, &newMinSelfDelegation, nil)
		if tc.expectPass {
			require.Nil(t, msg.ValidateBasic(), "test: %v", tc.name)
		} else {
			require.NotNil(t, msg.ValidateBasic(), "test: %v", tc.name)
...
func TestMsgDelegate(t *testing.T) {
	tests := []struct {
		...
		{"basic good", sdk.CUAddress(valAddr1), valAddr2, coinPos, true},
		{"self bond", sdk.CUAddress(valAddr1), valAddr1, coinPos, true},
		{"empty delegator", sdk.CUAddress(emptyAddr), valAddr1, coinPos, false},
		{"empty validator", sdk.CUAddress(valAddr1), emptyAddr, coinPos, false},
		{"empty bond", sdk.CUAddress(valAddr1), valAddr2, coinZero, false},
	}
...
func TestMsgBeginRedelegate(t *testing.T) {
	tests := []struct {
		...
		{"regular", sdk.CUAddress(valAddr1), valAddr2, valAddr3, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), true},
		{"zero amount", sdk.CUAddress(valAddr1), valAddr2, valAddr3, sdk.NewInt64Coin(sdk.DefaultBondDenom, 0), false},
		{"empty delegator", sdk.CUAddress(emptyAddr), valAddr1, valAddr3, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), false},
		{"empty source validator", sdk.CUAddress(valAddr1), emptyAddr, valAddr3, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), false},
		{"empty destination validator", sdk.CUAddress(valAddr1), valAddr2, emptyAddr, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), false},
	}
...
func TestMsgUndelegate(t *testing.T) {
	tests := []struct {
		...
		{"regular", sdk.CUAddress(valAddr1), valAddr2, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), true},
		{"zero amount", sdk.CUAddress(valAddr1), valAddr2, sdk.NewInt64Coin(sdk.DefaultBondDenom, 0), false},
		{"empty delegator", sdk.CUAddress(emptyAddr), valAddr1, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), false},
		{"empty validator", sdk.CUAddress(valAddr1), emptyAddr, sdk.NewInt64Coin(sdk.DefaultBondDenom, 1), false},
	}
