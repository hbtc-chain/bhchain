...
type DVPair struct {
	DelegatorAddress sdk.CUAddress
...
// Delegation represents the bond with tokens held by an CustodianUnit. It is
...
func NewDelegation(delegatorAddr sdk.CUAddress, validatorAddr sdk.ValAddress,
...
func (d Delegation) GetDelegatorAddr() sdk.CUAddress  { return d.DelegatorAddress }
...
type UnbondingDelegation struct {
	DelegatorAddress sdk.CUAddress              `json:"delegator_address" yaml:"delegator_address"` // delegator
...
func NewUnbondingDelegation(delegatorAddr sdk.CUAddress,
...
func NewRedelegation(delegatorAddr sdk.CUAddress, validatorSrcAddr,
...
func NewDelegationResp(d sdk.CUAddress, v sdk.ValAddress, s sdk.Dec, b sdk.Int) DelegationResponse {
...
func NewRedelegationResponse(d sdk.CUAddress, vSrc, vDst sdk.ValAddress, entries []RedelegationEntryResponse) RedelegationResponse {
