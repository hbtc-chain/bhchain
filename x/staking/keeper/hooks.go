...
func (k Keeper) BeforeDelegationCreated(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	if k.hooks != nil {
...
func (k Keeper) BeforeDelegationSharesModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	if k.hooks != nil {
...
func (k Keeper) BeforeDelegationRemoved(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	if k.hooks != nil {
...
func (k Keeper) AfterDelegationModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	if k.hooks != nil {
...
func (k Keeper) AfterNewEpoch(ctx sdk.Context, epoch sdk.Epoch) {
	if k.hooks != nil {
		k.hooks.AfterNewEpoch(ctx, epoch)
	}
}
