...
func (k Keeper) Delegation(ctx sdk.Context, addrDel sdk.CUAddress, addrVal sdk.ValAddress) exported.DelegationI {
...
func (k Keeper) IterateDelegations(ctx sdk.Context, delAddr sdk.CUAddress,
