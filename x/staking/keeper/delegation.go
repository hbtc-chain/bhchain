...
func (k Keeper) GetDelegation(ctx sdk.Context,
	delAddr sdk.CUAddress, valAddr sdk.ValAddress) (
...
func (k Keeper) GetDelegatorDelegations(ctx sdk.Context, delegator sdk.CUAddress,
...
func (k Keeper) GetUnbondingDelegations(ctx sdk.Context, delegator sdk.CUAddress,
...
func (k Keeper) GetUnbondingDelegation(ctx sdk.Context,
	delAddr sdk.CUAddress, valAddr sdk.ValAddress) (ubd types.UnbondingDelegation, found bool) {
...
func (k Keeper) HasMaxUnbondingDelegationEntries(ctx sdk.Context,
	delegatorAddr sdk.CUAddress, validatorAddr sdk.ValAddress) bool {
...
func (k Keeper) SetUnbondingDelegationEntry(ctx sdk.Context,
	delegatorAddr sdk.CUAddress, validatorAddr sdk.ValAddress,
...
func (k Keeper) GetRedelegations(ctx sdk.Context, delegator sdk.CUAddress,
...
func (k Keeper) GetRedelegation(ctx sdk.Context,
	delAddr sdk.CUAddress, valSrcAddr, valDstAddr sdk.ValAddress) (red types.Redelegation, found bool) {
...
func (k Keeper) HasReceivingRedelegation(ctx sdk.Context,
	delAddr sdk.CUAddress, valDstAddr sdk.ValAddress) bool {
...
func (k Keeper) HasMaxRedelegationEntries(ctx sdk.Context,
	delegatorAddr sdk.CUAddress, validatorSrcAddr,
...
func (k Keeper) Delegate(ctx sdk.Context, delAddr sdk.CUAddress, bondAmt sdk.Int, tokenSrc sdk.BondStatus,
	validator types.Validator, subtractAccount bool) (result sdk.Result, newShares sdk.Dec, err sdk.Error) {

	// In some situations, the exchange rate becomes invalid, e.g. if
	// Validator loses all tokens due to slashing. In this case,
	// make all future delegations invalid.
	if validator.InvalidExRate() {
		return result, sdk.ZeroDec(), types.ErrDelegatorShareExRateInvalid(k.Codespace())
	}
	...
	if subtractAccount {
		...
		var err sdk.Error
		result, err = k.supplyKeeper.DelegateCoinsFromAccountToModule(ctx, delegation.DelegatorAddress, sendName, coins)
		if err != nil {
			return result, sdk.Dec{}, err
		}
	} else {
		...
		case (tokenSrc == sdk.Unbonded || tokenSrc == sdk.Unbonding) && validator.IsBonded():
			// transfer pools
			result = k.notBondedTokensToBonded(ctx, bondAmt)
		case tokenSrc == sdk.Bonded && !validator.IsBonded():
			// transfer pools
			result = k.bondedTokensToNotBonded(ctx, bondAmt)
		default:
...
func (k Keeper) unbond(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress,
...
func (k Keeper) Undelegate(
	ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress, sharesAmount sdk.Dec,
) (time.Time, sdk.Error) {
...
func (k Keeper) CompleteUnbonding(ctx sdk.Context, delAddr sdk.CUAddress,
	...
	for i := 0; i < len(ubd.Entries); i++ {
		...
		if entry.IsMature(ctxTime) {
			...
			if !entry.Balance.IsZero() {
				...
				_, err := k.supplyKeeper.UndelegateCoinsFromModuleToAccount(ctx, types.NotBondedPoolName, ubd.DelegatorAddress, amt)
				if err != nil {
					return err
				}
			}
...
func (k Keeper) BeginRedelegation(ctx sdk.Context, delAddr sdk.CUAddress,
	...
	_, sharesCreated, err := k.Delegate(ctx, delAddr, returnAmount, srcValidator.GetStatus(), dstValidator, false)
	if err != nil {
		return time.Time{}, err
	}
...
// retrieved unbonding delegation object.
func (k Keeper) CompleteRedelegation(ctx sdk.Context, delAddr sdk.CUAddress,
...
func (k Keeper) ValidateUnbondAmount(
	ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress, amt sdk.Int,
