...
func (k Keeper) IsActiveKeyNode(ctx sdk.Context, addr sdk.CUAddress) (bool, int) {
	vals := k.GetCurrentEpoch(ctx).KeyNodeSet
...
func (k Keeper) UnbondAllMatureDelegation(ctx sdk.Context) {
...
func (k Keeper) RemoveAllMatureRedelegation(ctx sdk.Context) {
