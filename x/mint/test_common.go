...
func getMockApp(t *testing.T, numGenAccs int, genState GenesisState, genAccs []custodianunit.CU) testInput {
	...
	bk := transfer.NewBaseKeeper(mApp.Cdc, keyTransfer, mApp.CUKeeper, nil, nil, rk, nil, nil, pk.Subspace(transfer.DefaultParamspace), transfer.DefaultCodespace, blacklistedAddrs)
	...
	return testInput{mApp, keeper, sk, *supplyKeeper, addrs, pubKeys, privKeys}
}
