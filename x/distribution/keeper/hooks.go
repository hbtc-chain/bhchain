...
func (h Hooks) AfterValidatorRemoved(ctx sdk.Context, _ sdk.ConsAddress, valAddr sdk.ValAddress) {
	...
	if !commission.IsZero() {
		...
		if !coins.IsZero() {
			...
			_, err := h.k.supplyKeeper.SendCoinsFromModuleToAccount(ctx, types.ModuleName, withdrawAddr, coins)
			if err != nil {
				panic(err)
			}
		}
...
// increment period
func (h Hooks) BeforeDelegationCreated(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	val := h.k.stakingKeeper.Validator(ctx, valAddr)
	h.k.incrementValidatorPeriod(ctx, val)
}

// withdraw delegation rewards (which also increments period)
func (h Hooks) BeforeDelegationSharesModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
	val := h.k.stakingKeeper.Validator(ctx, valAddr)
...
func (h Hooks) AfterDelegationModified(ctx sdk.Context, delAddr sdk.CUAddress, valAddr sdk.ValAddress) {
...
func (h Hooks) AfterNewEpoch(sdk.Context, sdk.Epoch)                                            {}
