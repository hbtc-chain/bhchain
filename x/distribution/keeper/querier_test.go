...
func getQueriedDelegationRewards(t *testing.T, ctx sdk.Context, cdc *codec.Codec, querier sdk.Querier, delegatorAddr sdk.CUAddress, validatorAddr sdk.ValAddress) (rewards sdk.DecCoins) {
	query := abci.RequestQuery{
...
func getQueriedDelegatorTotalRewards(t *testing.T, ctx sdk.Context, cdc *codec.Codec, querier sdk.Querier, delegatorAddr sdk.CUAddress) (response types.QueryDelegatorTotalRewardsResponse) {
	query := abci.RequestQuery{
...
func TestQueries(t *testing.T) {
	...
	delRewards := getQueriedDelegatorTotalRewards(t, ctx, cdc, querier, sdk.CUAddress(valOpAddr1))
