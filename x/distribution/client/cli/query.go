...
Example:
$ %s query distr validator-outstanding-rewards bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr commission bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr slashes bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj 0 100
`,
				version.ClientName,
			),
		),
...
Example:
$ %s query distr rewards BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp
$ %s query distr rewards BHhhzxqNNjw3qx4ZjaR9mnJeLRC1FxPWEyp bhvaloper1lh86pkhl6nrvmyezmncwdvhmnr0hj6nlk0caaj
`,
