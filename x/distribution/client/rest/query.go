...
type ValidatorDistInfo struct {
	OperatorAddress     sdk.CUAddress                        `json:"operator_address" yaml:"operator_address"`
...
func NewValidatorDistInfo(operatorAddr sdk.CUAddress, rewards sdk.DecCoins,
...
func validatorInfoHandlerFn(cliCtx context.CLIContext, queryRoute string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		// self bond rewards
		delAddr := sdk.CUAddress(validatorAddr)
...
func validatorRewardsHandlerFn(cliCtx context.CLIContext, queryRoute string) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		delAddr := sdk.CUAddress(validatorAddr).String()
