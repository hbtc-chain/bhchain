...
func NewQueryDelegationRewardsParams(delegatorAddr sdk.CUAddress, validatorAddr sdk.ValAddress) QueryDelegationRewardsParams {
...
func NewQueryDelegatorWithdrawAddrParams(delegatorAddr sdk.CUAddress) QueryDelegatorWithdrawAddrParams {
