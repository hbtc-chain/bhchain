...
type MsgSetWithdrawAddress struct {
	...
	WithdrawAddress  sdk.CUAddress `json:"withdraw_address" yaml:"withdraw_address"`
}

func NewMsgSetWithdrawAddress(delAddr, withdrawAddr sdk.CUAddress) MsgSetWithdrawAddress {
...
func (msg MsgSetWithdrawAddress) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{sdk.CUAddress(msg.DelegatorAddress)}
}
...
func NewMsgWithdrawDelegatorReward(delAddr sdk.CUAddress, valAddr sdk.ValAddress) MsgWithdrawDelegatorReward {
...
// Return address that must sign over msg.GetSignBytes()
func (msg MsgWithdrawDelegatorReward) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{sdk.CUAddress(msg.DelegatorAddress)}
}
...
// Return address that must sign over msg.GetSignBytes()
func (msg MsgWithdrawValidatorCommission) GetSigners() []sdk.CUAddress {
	return []sdk.CUAddress{sdk.CUAddress(msg.ValidatorAddress.Bytes())}
}
