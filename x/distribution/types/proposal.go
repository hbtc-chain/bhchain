...
func init() {
	...
	govtypes.RegisterProposalTypeCodec(CommunityPoolSpendProposal{}, "hbtcchain/CommunityPoolSpendProposal")
}
...
func NewCommunityPoolSpendProposal(title, description string, recipient sdk.CUAddress, amount sdk.Coins) CommunityPoolSpendProposal {
...
func (csp CommunityPoolSpendProposal) ProposalToken() string { return sdk.NativeToken }
