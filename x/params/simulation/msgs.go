...
var paramChangePool = []simParamChange{
	...
	// minting parameters
	{
		...
		"",
		func(r *rand.Rand) string {
			return fmt.Sprintf("\"%s\"", simulation.ModuleParamSimulator[simulation.Inflation](r).(sdk.Dec))
		},
	},
	{
		"mint",
		...
		"",
		func(r *rand.Rand) string {
			return fmt.Sprintf("\"%s\"", simulation.ModuleParamSimulator[simulation.InitialMintPerBlock](r).(sdk.Dec))
		},
	},
	// gov parameters
	{
...
func SimulateParamChangeProposalContent(r *rand.Rand, _ *baseapp.BaseApp, _ sdk.Context, _ []simulation.CU) gov.Content {
