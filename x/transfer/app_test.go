...
var (
	...
	freeFee   = custodianunit.NewStdFee(100000, sdk.Coins{sdk.NewInt64Coin("foocoin", 0)})
...
func TestSendNotEnoughBalance(t *testing.T) {
	...
	mock.SignCheckDeliver(t, mapp.Cdc, mapp.BaseApp, header, []sdk.Msg{sendMsg}, []uint64{origSeq}, false, false, priv1)
