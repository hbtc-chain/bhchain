...
import (
	...
	"github.com/hbtc-chain/bhchain/x/transfer/client/cli"
	"github.com/hbtc-chain/bhchain/x/transfer/client/rest"
...
type AppModule struct {
	...
	receiptKeeper types.ReceiptKeeper
	cn            types.Chainnode
}
...
func (am AppModule) RegisterInvariants(ir sdk.InvariantRegistry) {
	keeper.RegisterInvariants(ir, am.cuKeeper)
}
