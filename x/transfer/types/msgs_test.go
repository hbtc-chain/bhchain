...
func TestMsgSendGetSignBytes(t *testing.T) {
	...
	expected := "{\"type\":\"hbtcchain/transfer/MsgSend\",\"value\":{\"amount\":[{\"amount\":\"10\",\"denom\":\"atom\"}],\"from_address\":\"HBCT9W8oJnZA4h71QAFyj4we4bF1AACEgxVJ\",\"to_address\":\"HBCT4xTMyxwd2ZwbDiiG1BfNbCs1gwrwHYho\"}}"
...
func TestMsgMultiSendGetSignBytes(t *testing.T) {
	...
	expected := "{\"type\":\"hbtcchain/transfer/MsgMultiSend\",\"value\":{\"inputs\":[{\"address\":\"HBCT9W8oJnZA4h71QAFyj4we4bF1AACEgxVJ\",\"coins\":[{\"amount\":\"10\",\"denom\":\"atom\"}]}],\"max_height\":\"0\",\"outputs\":[{\"address\":\"HBCT4xTMyxwd2ZwbDiiG1BfNbCs1gwrwHYho\",\"coins\":[{\"amount\":\"10\",\"denom\":\"atom\"}]}]}}"
	require.Equal(t, expected, string(res))
}
