...
func RegisterCodec(cdc *codec.Codec) {
	...
	cdc.RegisterConcrete(MsgCreateDex{}, "hbtcchain/openswap/MsgCreateDex", nil)
	cdc.RegisterConcrete(MsgEditDex{}, "hbtcchain/openswap/MsgEditDex", nil)
	cdc.RegisterConcrete(MsgCreateTradingPair{}, "hbtcchain/openswap/MsgCreateTradingPair", nil)
	cdc.RegisterConcrete(MsgEditTradingPair{}, "hbtcchain/openswap/MsgEditTradingPair", nil)
