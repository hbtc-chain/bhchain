...
func DefaultGenesisState() GenesisState {
	...
	return GenesisState{
		...
		DepositParams: DepositParams{
			...
			MinDaoInitDeposit: sdk.Coins{sdk.NewCoin(sdk.NativeDefiToken, minInitDaoDepositTokens)},
			MinDaoDeposit:     sdk.Coins{sdk.NewCoin(sdk.NativeDefiToken, minDaoDepositTokens)},
