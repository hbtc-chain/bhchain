...
func getQueriedProposals(t *testing.T, ctx sdk.Context, cdc *codec.Codec, querier sdk.Querier, depositor, voter sdk.CUAddress, status ProposalStatus, limit uint64) []Proposal {
	tmp := NewQueryProposalsParams(status, limit, voter, depositor)
	query := abci.RequestQuery{
		Path: strings.Join([]string{custom, QuerierRoute, QueryProposals}, "/"),
		Data: cdc.MustMarshalJSON(tmp),
	}
...
func getQueriedDeposit(t *testing.T, ctx sdk.Context, cdc *codec.Codec, querier sdk.Querier, proposalID uint64, depositor sdk.CUAddress) Deposit {
	query := abci.RequestQuery{
...
func getQueriedVote(t *testing.T, ctx sdk.Context, cdc *codec.Codec, querier sdk.Querier, proposalID uint64, voter sdk.CUAddress) Vote {
	query := abci.RequestQuery{
