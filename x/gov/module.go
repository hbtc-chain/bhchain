...
import (
	...
	"github.com/hbtc-chain/bhchain/x/gov/client"
	"github.com/hbtc-chain/bhchain/x/gov/client/cli"
	"github.com/hbtc-chain/bhchain/x/gov/client/rest"
...
func (a AppModuleBasic) RegisterRESTRoutes(ctx context.CLIContext, rtr *mux.Router) {
	...
	for _, proposalHandler := range a.proposalHandlers {
		if proposalHandler.RESTHandler != nil {
...
func (a AppModuleBasic) GetTxCmd(cdc *codec.Codec) *cobra.Command {
	...
	for _, proposalHandler := range a.proposalHandlers {
		if proposalHandler.CLIHandler != nil {
