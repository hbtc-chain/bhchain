...
// ALIASGEN: github.com/hbtc-chain/bhchain/x/gov/types
package gov
...
var (
	...
	ErrInvalidProposalVoteTime    = types.ErrInvalidProposalVoteTime
...
type (
	...
	MsgDaoVote           = types.MsgDaoVote
	MsgCancelDaoVote     = types.MsgCancelDaoVote
	...
	Vote                 = types.Vote
	DaoVote              = types.DaoVote
	Votes                = types.Votes
	DaoVotes             = types.DaoVotes
