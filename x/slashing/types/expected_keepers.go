...
// CUKeeper expected CustodianUnit keeper
type CUKeeper interface {
	IterateCUs(ctx sdk.Context, process func(custodianunit.CU) (stop bool))
}
...
type StakingKeeper interface {
	...
	Delegation(sdk.Context, sdk.CUAddress, sdk.ValAddress) exported.DelegationI
