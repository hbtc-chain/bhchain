...
func getInitChainer(mapp *mock.App, keeper staking.Keeper, cuKeeper types.CUKeeper, supplyKeeper types.SupplyKeeper,
...
func checkValidator(t *testing.T, mapp *mock.App, keeper staking.Keeper,
	addr sdk.CUAddress, expFound bool) staking.Validator {
...
func TestSlashingMsgs(t *testing.T) {
	...
	// advance to trigger validator set update
	...
	header = abci.Header{Height: mapp.LastBlockHeight() + 1}
	res, _, _ := mock.SignCheckDeliver(t, mapp.Cdc, mapp.BaseApp, header, []sdk.Msg{unjailMsg}, []uint64{1}, false, false, priv1)
