/*
Package bhexapp implements a full fledged Cosmos SDK application used for executing
simulation test suites.

Simulation App

The bhexapp type defines an application used for running extensive simulation
