...
import (
	...
	"github.com/hbtc-chain/bhchain/store/cachekv"
	serrors "github.com/hbtc-chain/bhchain/store/errors"
...
func LoadStore(db dbm.DB, id types.CommitID, pruning types.PruningOptions, lazyLoading bool) (types.CommitStore, error) {
	tree := iavl.NewMutableTree(db, defaultIAVLCacheSize, id.Version)
