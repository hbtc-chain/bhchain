...
import (
	...
	srvconfig "github.com/hbtc-chain/bhchain/server/config"
	...
	genutiltypes "github.com/hbtc-chain/bhchain/x/genutil/types"
...
Example:
	...
	cmd.Flags().String(flagNodeDaemonHome, "hbtcchain",
		"Home directory of the node's daemon configuration")
	cmd.Flags().String(flagNodeCLIHome, "hbtccli",
