...
import (
	...
	cryptokeys "github.com/hbtc-chain/bhchain/crypto/keys"
...
// WithFromAddress returns a copy of the context with an updated from CU
// address.
...
// GetFromFields returns a from CU address and Keybase name given either
...
func GetFromFields(from string, genOnly bool) (sdk.CUAddress, string, error) {
	...
	if genOnly {
		addr, err := sdk.CUAddressFromBase58(from)
		if err != nil {
	...
	if addr, err := sdk.CUAddressFromBase58(from); err == nil {
