...
func TestCreateLedger(t *testing.T) {
	...
	assert.Equal(t, "hbcpub1addwnpepqgxrxn9uctvhjxndwmr4rsnk0u900h5wmlxszcwd697samj0uecfkz5qhew", pk)
	...
	assert.NoError(t, err)
	assert.Equal(t, "44'/496'/3'/0/1", path.String())
}
...
func TestKeyManagement(t *testing.T) {
	...
	require.NoError(t, err)
	addr, err := sdk.CUAddressFromBase58("HBCLmQcskpdQivEkRrh1gNPm7c9aVB8hh1fy")
	require.NoError(t, err)
...
func accAddr(info Info) sdk.CUAddress {
	return (sdk.CUAddress)(info.GetPubKey().Address())
}
