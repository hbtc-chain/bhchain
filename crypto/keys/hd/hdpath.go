...
// m / purpose' / coinType' / CU' / change / addressIndex
...
// m / purpose' / coinType' / CU' / change / addressIndex
func NewParams(purpose, coinType, CU uint32, change bool, addressIdx uint32) *BIP44Params {
	return &BIP44Params{
		Purpose:      purpose,
		CoinType:     coinType,
		CU:           CU,
...
// m / 44' / coinType' / CU' / 0 / address_index
// The fixed parameters (purpose', coin_type', and change) are determined by what was used in the fundraiser.
func NewFundraiserParams(CU, coinType, addressIdx uint32) *BIP44Params {
	return NewParams(44, coinType, CU, false, addressIdx)
}
...
func (p BIP44Params) String() string {
	...
	// m / Purpose' / coin_type' / CU' / Change / address_index
