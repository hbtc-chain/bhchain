...
import (
	...
	store "github.com/hbtc-chain/bhchain/store/types"
...
func registerTestCodec(cdc *codec.Codec) {
	...
	// register test types
	cdc.RegisterConcrete(&txTest{}, "hbtcchain/baseapp/txTest", nil)
	cdc.RegisterConcrete(&msgCounter{}, "hbtcchain/baseapp/msgCounter", nil)
	cdc.RegisterConcrete(&msgCounter2{}, "hbtcchain/baseapp/msgCounter2", nil)
	cdc.RegisterConcrete(&msgNoRoute{}, "hbtcchain/baseapp/msgNoRoute", nil)
}
...
func (msg msgCounter) GetSigners() []sdk.CUAddress { return nil }
...
func (msg msgCounter2) GetSigners() []sdk.CUAddress { return nil }
...
func TestRunInvalidTransaction(t *testing.T) {
	...
	// Transaction with an unregistered message
	{
		...
		newCdc.RegisterConcrete(&msgNoDecode{}, "hbtcchain/baseapp/msgNoDecode", nil)
