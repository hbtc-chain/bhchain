...
const (
	DefaultSettleQuota = uint64(20000000)
)
...
func (app *BaseApp) BeginBlock(req abci.RequestBeginBlock) (res abci.ResponseBeginBlock) {
	...
	app.deliverState.ctx = app.deliverState.ctx.WithBlockGasMeter(gasMeter).
		WithSettleQuota(sdk.NewBasicSettleQuota(DefaultSettleQuota))
...
func (app *BaseApp) cacheTxContext(ctx sdk.Context, txBytes []byte) (
	...
	ms := ctx.MultiStore()
	// TODO: https://github.com/hbtc-chain/bhchain/issues/2824
...
func (app *BaseApp) runTx(mode runTxMode, txBytes []byte, tx sdk.Tx) (result sdk.Result) {
	...
	if app.anteHandler != nil {
		...
		// Ref: https://github.com/hbtc-chain/bhchain/issues/2772
		//
